...
echo $rs_obmp_review->pulizia_camera ;
?>
...
// Change the css classes to suit your needs    
    ...
    <?php echo form_error('user_type'); ?>
        ...
        <input id="review_id" type="hidden" name="review_id"  value="<?php echo $rs_client->ireview_id; ; ?>">  
        <input id="hotel_id" type="hidden" name="hotel_id"  value="<?php echo $rs_client->ihotel_id; ?>">
        <input id="preno_id" type="hidden" name="preno_id"  value="<?php echo $rs_client->ipreno_id; ?>">
        <input id="conto_id" type="hidden" name="conto_id"  value="<?php echo $rs_client->iconto_id; ?>" >
        <input id="postazione_id" type="hidden" name="postazione_id"  value="<?php echo $rs_client->ipreno_id; ?>">  
        <input id="camera_numero" type="hidden" name="camera_numero"  value="<?php echo $rs_client->icamera_id; ?>" > 
        <input id="nome" type="hidden" name="nome"  value="<?php echo $rs_client->iclienti_cogno; ?>"  >     

                                        ...
                                        <table class="container">
                                            <tr>
                                                <td class="wrapper last"><table class="twelve columns">
                                                        <tr>
                                                            <td class="six sub-columns"><a href="http://<?php echo $web ?>  "><img src="<?php echo $logo ?>" /></a></td>
                                                            <td class="six sub-columns last" style="text-align:right; vertical-align:middle;"><span class="template-label"> <?php echo $citta ?> - <?php echo $giorno ?>                              </span></td>
                                                    ...
                                                    <tr>
                                                        <td class="left-text-pad"><h5>Connect With Us:</h5>
                                                            <table class="tiny-button sitohotel">
                                                                <tr>
                                                                    <td><a href="http://<?php echo $web ?>">Hotel Site</a></td>
                                                                </tr>
                                                            </table>
                                                            <br />
                                                            <table class="tiny-button facebook">
                                                                <tr>
                                                                    <td><a href="http://<?php echo $facebook ?>">Facebook</a></td>
                                                                </tr>
                                                            </table>
                                                            <br />
                                                            <table class="tiny-button google-plus">
                                                                <tr>
                                                                    <td><a href="http://<?php echo $googlep ?>">Google +</a></td>
                                                                </tr>
                                                            </table></td>
                                                        <td class="expander"></td>
                                                    </tr>
                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td class="last right-text-pad"><h5>Contact Info:</h5>
                                                            <p>Phone: <?php echo $telefono ?> </p>
                                                            <p>Email: <a href="mailto: <?php echo $email ?>"><?php echo $email ?></a></p>
                                                            <p><?php echo $hotelnome ?> </p>
                                                            <p><?php echo $indirizzo ?>  <?php echo $citta ?> </p></td>
                                                        <td class="expander"></td>
                                                    </tr>
                                                </table>

                ...
                <div class="small-7 large-7 columns">
                    ...
                    <div class="row">
                            ...
                            <div class="small-12 large-12 columns">
                                <a href="<?php echo base_url(); ?>/index.php/clienti/bookings_edit/<?php echo $rs_clienti[0]->conto_id; ?>/<?php  echo  $rs_clienti[0]->clienti_id; ?>/<?php  echo  $row_new->preno_id; ?>" class="button success small right">Amministra Preno </a>
                            </div>
                ...
                <div class="small-7 large-7 columns">
                    ...
                    <div class="row">
                        <?php if (!isset($row->review_id)) { ?>
                            ...
                            <div class="small-12 large-12 columns">
                                <a href="<?php echo base_url(); ?>index.php/obmp_review/insert/<?php echo $row->conto_id; ?>/<?php  echo  $row->clienti_id; ?>  " class="button small round right">Scrivi Review</a>
                            </div>
                            <?php } else { ?>
                            <div class="small-12 large-12 columns">
                                <a href="<?php echo base_url(); ?>index.php/obmp_review/edit/<?php echo $row->conto_id; ?>/<?php  echo  $row->clienti_id; ?> " class="button small success round right">You Review </a>
                            </div>
                         <?php } ?>
                    </div>
                </div>

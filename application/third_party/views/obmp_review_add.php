    ...
    <?php echo form_textarea(array('name' => 'commento_tex', 'rows' => '5', 'cols' => '80', 'value' => set_value('commento_tex'))) ?>
        ...
        <p>
         <?php echo lang('raccomandi', 'raccomandi'); ?>   
            ...
            <input id="raccomandi2" name="raccomandi" type="radio" class="" value="10" <?php echo $this->form_validation->set_radio('raccomandi', '2'); ?> />
         <br>
    <?php echo $this->lang->line('no'); ?> 

            <input id="raccomandi6" name="raccomandi" type="radio" class="" value="2" <?php echo $this->form_validation->set_radio('raccomandi', '10'); ?> /> 

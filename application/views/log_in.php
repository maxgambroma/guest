...
<div id="login">
    <div class="row">
        <div class="medium-6 medium-centered large-6 large-centered columns">
            ...
            echo form_open(uri_string() . '?' . $_SERVER['QUERY_STRING'], $attributes, 'pippo' );
            ?>   
            <div class="row column log-in-form">
                <h4 class="text-center">Log in with you email account</h4>
                <?php
                if ($this->input->get('stato') > 0) {
                ...
                <p>
                    ...
                    <input id="user" type="email" name="user"   placeholder="somebody@example.com"  value="<?php echo set_value('user'); ?>"  />
                </p>
                <p>

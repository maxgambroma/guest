        ...
        <div id="calendario1" class="av-summary" > 
            <div class="row"> 
                <div class="small-4 large-3 columns">
                    <p>   From  <br> <?php echo date("D M j Y", strtotime($preno_dal));
; ?></p>
                </div>
                <div class="small-4 large-3 columns">
                    <p>   To <br> <?php echo date("D M j Y", strtotime($preno_al));
; ?> </p>
                </div>
                <div class="small-4 large-3 columns">
                ...
                <div class="row">
                    <div class="box_booking">                       
                        <div class="small-12 large-4 columns box_booking"> 
                            ...
                            <form action="<?php echo base_url() . 'index.php/obmp/index/?hotel_id='.$hotel_id ; ?>" method="post" id="form_prezzi" name="form_prezzi">
                                <div class="row">
